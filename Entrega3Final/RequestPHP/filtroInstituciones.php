...
// mantengo utf8 para respetar nombres acentuados
...
// rutas alineadas con la estructura general
...
// dejo encabezado limpio antes de clasificar filas
...
while(($r=fgetcsv($I,0,$sep,'"','\\'))!==false){
  ...
  // enlace
  // normalizo url para evitar variantes http o slash final
  if($ixEnl!==false){
  ...
  // rut
  // recalculo dv y dejo formato canonico
  if($ixRut!==false){
    $o=$r[$ixRut];
