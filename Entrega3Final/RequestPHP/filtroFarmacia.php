...
// rutas y carpetas alineadas con los otros filtros
...
// tipo y estado quedan forzados a un vocabulario fijo

// Lectura para preparear csv
...
// alineo encabezados antes de registrar filas
...
// set evita repetir códigos de catálogo
...
while(($r=fgetcsv($I,0,$SEP,$ENC,$ESC))!==false){
  ...
  $seenCod[$cod] = true;
  // descarto segunda aparición para proteger el maestro
  ...
  // esencial se guarda solo como binario
...
// cierro manijas para evitar fugas de descriptor
