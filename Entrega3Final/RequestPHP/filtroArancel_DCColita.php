#!/usr/bin/env php
<?php
// Selecionamos mejor fila pierdo datos per mejora para las duplicidad de codigo
// Mantiene un único registro por código interno priorizando descripciones limpias y códigos Fonasa validos

mb_internal_encoding('UTF-8');
// copio las rutas del resto de los scripts
...
// si el archivo no se deja leer mejor me entere ahora que mas tarde
if (!is_readable($IN)) {
    fwrite(STDERR, "No puedo leer $IN\n");
    exit(1);
}

// toda esta tanda de helpers la arme para no repetir corte
...
// ahora viene la faena linea por linea asi que paciencia
...
// quien gana cuando tengo duplicados
...
// al final escribo los ok y los errores
