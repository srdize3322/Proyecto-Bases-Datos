#!/usr/bin/env php
<?php
// E3/RequestPHP/filtroPlanes.php — limpia los archivos de planes en Old/planes/
// Resultados: Depurado/planes/<nombre>_OK.csv y Logs/planes/<nombre>_LOG.txt
// Reglas:
//   - bonificacion: entero entre 0 y 100; vacíos/NULL -> 0; valores fuera de rango se saturan.
//   - grupo: texto normalizado (mojibake, espacios) y truncado a 100 caracteres.
