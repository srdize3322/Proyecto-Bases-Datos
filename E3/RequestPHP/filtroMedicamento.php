#!/usr/bin/env php
<?php
// E3/RequestPHP/filtroMedicamento.php — depuración de Medicamento.csv
// Reglas:
// - IDAtencion entero obligatorio, debe existir en Atencion_OK.csv.
// - Medicamento (nombre) y Posologia se normalizan (trim, espacios compactados, mojibake) y se truncan a 100 caracteres.
// - Posologia vacía se reemplaza por "Sin posologia".
// - Psicotropico se normaliza a TRUE/FALSE (acepta variantes 1/0/si/no); valores fuera de dominio -> ERR.
