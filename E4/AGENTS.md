...
- Directorios de output: los `.txt` generados por `SPorden.sql` viven en `recetas/`, `recetas_psico/` y `ordenes/` (crea estas carpetas y pasa siempre la ruta absoluta del proyecto como segundo parámetro de `generar_documentos`).
